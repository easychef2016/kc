...
//GenericIdentity  - implementation
using System.Security.Principal;

namespace EasyChefDemo.Services
{
    ...
    public class MembershipService : IMembershipService
    {
        ...
        public User UpdateUser(string username, string email, string password, int[] roles)
        {
            var existingUser = _userRepository.GetSingleByUsername(username);
        ...
        public User UpdateUserEdit(string username,bool Islocked)
        {
            var existingUser = _userRepository.GetSingleByUsername(username);
